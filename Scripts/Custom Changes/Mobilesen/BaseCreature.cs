...
namespace Server.Mobiles
{
	...
	public enum DarkFurType
	{
		DarkFur
	}

	public enum LightFurType
	{
		LightFur
	}
	...
	public class BaseCreature : Mobile
	{
							...
							if ( master != null )
							{
								if ( m_dMinTameSkill <= 29.1 || master.Skills[SkillName.AnimalTaming].Value >= m_dMinTameSkill || this is SwampDragon || this is Ridgeback || this is SavageRidgeback )
								{
									...
									else if ( (BondingBegin + BondingDelay) <= DateTime.Now )
									{
										...
										from.SendAsciiMessage( "Your pet has bonded with you!" );
								}
							}
						}
						}*/
		...
		public virtual int LightFur{ get{ return 0; } }
		public virtual LightFurType LightFurType{ get{ return LightFurType.LightFur; } }

		public virtual int DarkFur{ get{ return 0; } }
		public virtual DarkFurType DarkFurType{ get{ return DarkFurType.DarkFur; } }
		...
		public virtual bool Teach( SkillName skill, Mobile m, int maxPointsToLearn, bool doTeach )
		{
			...
			switch ( res )
			{
				...
				{
					m.SendAsciiMessage( 0x22, "Make sure this skill is marked to raise. If you are near the skill cap (700 points) you may need to lose some points in another skill first." );
					break;
				}
				case TeachResult.Success:
				{
					if ( doTeach )
					{
						...
						m.SendAsciiMessage( "Your skill level increases." );
		...
		public bool SetControlMaster( Mobile m )
		{
			...
			else
			{
				...
				{
					m.SendAsciiMessage( "You have too many followers to control that creature." );
					return false;
				}
