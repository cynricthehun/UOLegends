...
namespace Server.Mobiles
{
	public class EtherealMount : Item, IMount, IMountItem, Engines.VeteranRewards.IRewardItem
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( !IsChildOf( from.Backpack ) )
				...
				from.SendAsciiMessage( "You are still too dazed from being knocked off your mount to ride!" );
			else if ( from.Mounted )
				from.SendAsciiMessage( "Please dismount first." );
			else if ( from.IsBodyMod && !from.Body.IsHuman )
				from.SendAsciiMessage( "You can't do that while polymorphed." );
			else if ( from.HasTrade )
				from.SendAsciiMessage( 0x41, "You may not ride at this time." );
			else if ( (from.Followers + FollowerSlots) > from.FollowersMax )
				from.SendAsciiMessage( "You have too many followers to summon your mount." );
		...
		private class EtherealSpell : Spell
		{
			...
			public override bool CheckSpellbook{ get{ return false; } }
			...
			{
				if ( message && !m_Stop )
					Caster.SendAsciiMessage( "You have been disrupted while attempting to summon your ethereal mount!" );
	...
	public class EtherealHorse : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal horse statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal horse statuette (donation item)" );
				}
			}
			else
			{
	...
	public class EtherealLlama : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal llama statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal llama statuette (donation item)" );
				}
			}
			else
			{
	...
	public class EtherealOstard : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal ostard statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal ostard statuette (donation item)" );
				}
			}
			else
			{
	...
	public class EtherealRidgeback : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal ridgeback statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal ridgeback statuette (donation item)" );
				}
			}
			else
			{
	...
	public class EtherealUnicorn : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal unicorn statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal unicorn statuette (donation item)" );
				}
			}
			else
			{
	...
	public class EtherealBeetle : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal beetle statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal beetle statuette (donation item)" );
				}
			}
			else
			{
	...
	public class EtherealKirin : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal ki-rin statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal ki-rin statuette (donation item)" );
				}
			}
			else
			{
	...
	public class EtherealSwampDragon : EtherealMount
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.IsRewardItem == true )
				{
					LabelTo( from, "an ethereal swamp dragon statuette (veteran reward)" );
				}
				else
				{
					LabelTo( from, "an ethereal swamp dragon statuette (donation item)" );
				}
			}
			else
			{
