...
namespace Server.Mobiles
{
	...
	public class Unicorn : BaseMount
	{
		...
		{
			m.SendAsciiMessage( "The unicorn refuses to allow you to ride it." );
		}
		...
		[Constructable]
		public Unicorn( string name ) : base( name, 0xe4, 0x3EA1, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
