	...
	public class SBMage : SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( Bloodmoss ), 6, 100, 0xF7B, 0 ) );
				...
				Add( new GenericBuyInfo( "1041267", typeof( Runebook ), 7500, 10, 0xEFA, 0x461 ) );
				Add( new GenericBuyInfo( typeof( RecallRune ), 3, 999, 0x1F14, 0 ) );
