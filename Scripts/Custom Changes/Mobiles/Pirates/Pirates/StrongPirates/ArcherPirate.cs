...
{ 
	public class ArcherPirate : BaseCreature 
	{
		private bool m_Bandage;

		[Constructable] 
		public ArcherPirate() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.175, 0.2 )
		{ 
			Title = "the pirate";
			Body = 400;
			Team = 1;
...
//*---------------->	BANDAGE
	    ...
	    { 
		   private ArcherPirate pirate;

                   public BandageTimer( ArcherPirate o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   pirate = o;
...
//<----------------------------* BANDAGE
		...
		public ArcherPirate( Serial serial ) : base( serial )
		{
		}
