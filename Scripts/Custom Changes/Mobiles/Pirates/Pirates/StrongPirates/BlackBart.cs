...
{ 
	public class BlackBart : BaseCreature 
	{
		...
		[Constructable] 
		public BlackBart() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.175, 0.2 )
		{ 
			Body = 400;
			Team = 1;
			Kills = 10;
        ...
        {
            private BlackBart pirate;

            public SpeechTimer(BlackBart o)
...
//*---------------->	BANDAGE
	    ...
	    { 
		   private BlackBart pirate;
                   ...
                   public BandageTimer( BlackBart o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   pirate = o;
		   Priority = TimerPriority.OneSecond; 
		   } 
...
//<----------------------------* BANDAGE
		...
		public BlackBart( Serial serial ) : base( serial )
		{
		}
