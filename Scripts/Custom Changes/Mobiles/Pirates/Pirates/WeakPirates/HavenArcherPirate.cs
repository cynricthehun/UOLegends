...
{ 
	public class HavenArcherPirate : BaseCreature 
	{
		private bool m_Bandage;

		[Constructable] 
		public HavenArcherPirate() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.175, 0.2 )
		{ 
			Title = "the pirate";
			Body = 400;
			Team = 1;
...
//*---------------->	BANDAGE
	    ...
	    { 
		   private HavenArcherPirate pirate;

                   public BandageTimer( HavenArcherPirate o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   pirate = o;
...
//<----------------------------* BANDAGE
		...
		public HavenArcherPirate( Serial serial ) : base( serial )
		{
		}
