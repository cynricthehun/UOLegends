...
{ 
	public class UndeadArcherPirateSTR : BaseCreature 
	{
		private bool m_Bandage;

		[Constructable] 
		public UndeadArcherPirateSTR() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.175, 0.2 )
		{ 
...
//*---------------->	BANDAGE
	    ...
	    { 
		   private UndeadArcherPirateSTR pirate;

                   public BandageTimer( UndeadArcherPirateSTR o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   pirate = o;
...
//<----------------------------* BANDAGE
		...
		public UndeadArcherPirateSTR( Serial serial ) : base( serial )
		{
		}
