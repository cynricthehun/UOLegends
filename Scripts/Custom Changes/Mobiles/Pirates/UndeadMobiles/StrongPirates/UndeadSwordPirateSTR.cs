...
{ 
	public class UndeadSwordPirateSTR : BaseCreature 
	{
...
//*---------------->	BANDAGE
	    ...
	    { 
		   private UndeadSwordPirateSTR pirate;

                   public BandageTimer( UndeadSwordPirateSTR o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   pirate = o;
...
//<----------------------------* BANDAGE
		...
		public UndeadSwordPirateSTR( Serial serial ) : base( serial )
		{
		}
