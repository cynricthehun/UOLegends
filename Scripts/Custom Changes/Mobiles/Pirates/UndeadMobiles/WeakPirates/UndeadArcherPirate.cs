...
{ 
	public class UndeadArcherPirate : BaseCreature 
	{
		private bool m_Bandage;

		[Constructable] 
		public UndeadArcherPirate() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.175, 0.2 )
		{ 
...
//*---------------->	BANDAGE
	    ...
	    { 
		   private UndeadArcherPirate pirate;

                   public BandageTimer( UndeadArcherPirate o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   pirate = o;
...
//<----------------------------* BANDAGE
		...
		public UndeadArcherPirate( Serial serial ) : base( serial )
		{
		}
