...
{ 
	public class UndeadSwordPirate : BaseCreature 
	{
		private bool m_Bandage;

		[Constructable] 
		public UndeadSwordPirate() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.175, 0.2 )
		{ 
...
//*---------------->	BANDAGE
	    ...
	    { 
		   private UndeadSwordPirate pirate;

                   public BandageTimer( UndeadSwordPirate o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   pirate = o;
...
//<----------------------------* BANDAGE
		...
		public UndeadSwordPirate( Serial serial ) : base( serial )
		{
		}
