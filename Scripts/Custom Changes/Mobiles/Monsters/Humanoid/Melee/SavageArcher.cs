...
namespace Server.Mobiles
{
	...
	public class SavageArcher : BaseCreature
	{
		private bool m_Bandage;

		[Constructable]
		public SavageArcher() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.Archery, 70.0, 92.5 );
			...
			PackItem( new Arrow( Utility.RandomMinMax( 1, 25 ) ) );
	    ...
	    { 
		   private SavageArcher savage;

                   public BandageTimer( SavageArcher o ) : base( TimeSpan.FromSeconds( 15 ) ) 
		   { 
                   savage = o;
		...
		public SavageArcher( Serial serial ) : base( serial )
		{
		}
