...
namespace Server.Mobiles
{
	...
	{
// bounty system
		private bool m_ShowBountyUpdate;
		private ArrayList m_BountyUpdateList = new ArrayList();

		public bool ShowBountyUpdate
		{
			get{ return m_ShowBountyUpdate; }
			set{ m_ShowBountyUpdate = value; }
		}
...
//end bounty system
//Duel System
		private bool m_SentRequest;
		private bool m_RecievedRequest;
		private int m_Wins;
		private int m_Losses;

		public bool SentRequest
		{
			get{ return m_SentRequest; }
			set{ m_SentRequest = value; }
		}
...
//End Duel System
		...
		{
			 if ( from.Spell != null && from.Spell is Spell) 
			{
				((Spell)from.Spell).Disturb( DisturbType.UseRequest ); 
			} 
			return true;
		 }
...
//end bounty system
		...
		public virtual void RecheckTownProtection()
		{
			...
			{
				if ( isProtected )
					SendMessage( "You are now under the protection of the town guards." );
				else
					SendMessage( "You have left the protection of the town guards." );
...
//end duel system
		...
		public override void OnSkillChange( SkillName skill, double oldBase )
		{
			if ( this.Young && this.SkillsTotal >= 4500 )
			{
				...
				if ( acc != null )
					acc.RemoveYoungStatus( "You have successfully obtained a respectable skill level, and have outgrown your status as a young player!" );
			}
