...
namespace Server.Engines.VeteranRewards
{
	public class RewardChoiceGump : Gump
	{
		...
		private void RenderCategories()
		{
			...
			else if ( rewardInterval == TimeSpan.FromDays( 180.0 ) )
				intervalAsString = "two months";
			else if ( rewardInterval == TimeSpan.FromDays( 270.0 ) )
			...
			AddHtml( 60, 35, 500, 70, "<B>Ultima Online Rewards Program</B><BR>" +
									"Thank you for being a part of the Legends of Ultima community for a full " + intervalAsString + ".  " +
