...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft( typeof( StuddedGorget ), 1015300, 1025078, 78.8, 103.8, typeof( Leather ), 1044462, 6, 1044463 );
			AddRes( index, typeof( IronIngot ), 1044036, 1, 1044253 );
			index = AddCraft( typeof( StuddedGloves ), 1015300, 1025077, 82.9, 107.9, typeof( Leather ), 1044462, 8, 1044463 );
			AddRes( index, typeof( IronIngot ), 1044036, 1, 1044253 );
			index = AddCraft( typeof( StuddedArms ), 1015300, 1025076, 87.1, 112.1, typeof( Leather ), 1044462, 10, 1044463 );
			AddRes( index, typeof( IronIngot ), 1044036, 2, 1044253 );
			index = AddCraft( typeof( StuddedLegs ), 1015300, 1025082, 91.2, 116.2, typeof( Leather ), 1044462, 12, 1044463 );
			AddRes( index, typeof( IronIngot ), 1044036, 3, 1044253 );
			index = AddCraft( typeof( StuddedChest ), 1015300, 1025083, 94.0, 119.0, typeof( Leather ), 1044462, 14, 1044463 );
			AddRes( index, typeof( IronIngot ), 1044036, 4, 1044253 );
			#endregion
			...
			index = AddCraft( typeof( StuddedBustierArms ), 1015306, 1027180, 82.9, 107.9, typeof( Leather ), 1044462, 8, 1044463 );
			AddRes( index, typeof( IronIngot ), 1044036, 4, 1044253 );
			AddCraft( typeof( FemaleLeatherChest ), 1015306, 1027174, 62.2, 87.2, typeof( Leather ), 1044462, 8, 1044463 );
			index = AddCraft( typeof( FemaleStuddedChest ), 1015306, 1027170, 87.1, 112.1, typeof( Leather ), 1044462, 10, 1044463 );
			AddRes( index, typeof( IronIngot ), 1044036, 4, 1044253 );
			#endregion
