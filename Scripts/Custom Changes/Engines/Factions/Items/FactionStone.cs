			...
			else if ( from is PlayerMobile )
			{
				...
				if ( existingFaction == m_Faction || from.AccessLevel >= AccessLevel.GameMaster )
				{
					...
					if ( pl != null && pl.IsLeaving )
						from.SendAsciiMessage( "You cannot use the faction stone until you have finished quitting your current faction." );
					else
				...
				{
					// TODO: Validate
					from.SendAsciiMessage( "This is not your faction stone!" );
				}
				else
				{
