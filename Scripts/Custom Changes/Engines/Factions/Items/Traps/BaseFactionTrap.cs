		...
		public virtual string IsValidLocation( Point3D p, Map m )
		{
			...
			switch( AllowedPlacing )
			{
				case AllowedPlacing.FactionStronghold:
				{
					...
					return "This trap can only be placed in your stronghold.";
				}
				case AllowedPlacing.AnyFactionTown:
				{
					...
					return "This trap can only be placed in a faction town.";
				}
				case AllowedPlacing.ControlledFactionTown:
				{
					...
					return "This trap can only be placed in a town your faction controls.";
				}
			}
