				...
				switch ( keywords[i] )
				{
					case 0x00E4: // *i wish to access the city treasury*
					{
						...
						if ( FactionGump.Exists( from ) )
							from.SendAsciiMessage( "You already have a faction menu open." );
					...
					case 0x00E5: // *i wish to resign as finance minister*
					{
						...
						if ( pl != null && pl.Finance != null )
						{
							...
							from.SendAsciiMessage( "You have been fired as Finance Minister." );
						}
					...
					case 0x00EE: // *i wish to resign as sheriff*
					{
						...
						if ( pl != null && pl.Sheriff != null )
						{
							...
							from.SendAsciiMessage( "You have been fired as Sheriff." );
						}
					...
					case 0x00E9: // *what is my faction term status*
					{
						...
						if ( pl != null && pl.IsLeaving )
						{
							...
							if( remaining.TotalDays >= 1 )
								from.SendAsciiMessage( "Your term of service will come to an end in " + remaining.TotalDays.ToString( "N0" ) + "days." );
							else if( remaining.TotalHours >= 1 )
								from.SendAsciiMessage( "Your term of service will come to an end in " + remaining.TotalHours.ToString( "N0" ) + " hours." );
							else
								from.SendAsciiMessage( "Your term of service will come to an end in less than one hour." );
						}
						else if ( pl != null )
						{
							from.SendAsciiMessage( "You are not in the process of quitting the faction." );
						}
					...
					case 0x00EA: // *message faction*
					{
						...
						if ( from.AccessLevel == AccessLevel.Player && !faction.FactionMessageReady )
							from.SendAsciiMessage( "The required time has not yet passed since the last message was sent." );
						else
