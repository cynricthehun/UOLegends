...
namespace Server.Factions
{
	public class Election
	{
		...
		public void RemoveCandidate( Mobile mob )
		{
			...
			mob.SendAsciiMessage( "There are no longer any valid candidates in the Faction Commander election." );

			if ( m_State == ElectionState.Election )
			{
				if ( m_Candidates.Count == 1 )
				{
					m_Faction.Broadcast( "There are no longer any valid candidates in the Faction Commander election." );
					...
					{
						m_Faction.Broadcast( "Faction leadership has not changed." );
					}
					else
					{
						m_Faction.Broadcast( "The faction has a new commander." );
		...
		public void Slice()
		{
			...
			switch ( m_State )
			{
				case ElectionState.Pending:
				{
					...
					m_Faction.Broadcast( "Campaigning for the Faction Commander election has begun." );
				...
				case ElectionState.Campaign:
				{
					...
					{
						m_Faction.Broadcast( "Nobody ran for office." );
						State = ElectionState.Pending;
					}
					else if ( m_Candidates.Count == 1 )
					{
						m_Faction.Broadcast( "Only one member ran for office." );
					...
					{
						m_Faction.Broadcast( "Voting for Faction Commander has begun." );
				...
				case ElectionState.Election:
				{
					...
					m_Faction.Broadcast( "The results for the Faction Commander election are in." ); 
					...
					{
						m_Faction.Broadcast( "The incumbent won the election." );
					}
					else
					{
						m_Faction.Broadcast( "The faction has a new commander." );
