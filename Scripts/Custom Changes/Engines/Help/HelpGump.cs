	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from ) : base( 0, 0 )
		{
			...
			AddPage( 1 );
				...
				AddHtml( 110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories. Please refer to: (http://www.freebb.com/index.php?freebb=legends), please use this option.", true, true );

			AddPage( 2 );

			AddButton( 80, 90, 5540, 5541, 3, GumpButtonType.Reply, 0 );
			AddHtml( 110, 90, 450, 74, @"<u>Report a bug or contact Origin.</u> Use this option to launch your web browser and post it on our forums. Your report will be read by our Quality Assurance Staff. We apologize for not being able to reply to individual reports. ", true, true );

			AddButton( 80, 170, 5540, 5541, 4, GumpButtonType.Reply, 0 );
			AddHtml( 110, 170, 450, 74, @"<u>Suggestion for the Game.</u> If you'd like to make a suggestion for the game, it should be directed to the Development Team Members who participate in the discussion forums on the http://www.freebb.com/index.php?freebb=legends web site. Choosing this option will take you to the Discussion Forums. ", true, true );
			...
			AddHtml( 110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at http://www.freebb.com/index.php?freebb=legends), and requires in-game assistance, use this option. ", true, true );
			...
			AddHtmlLocalized( 110, 90, 450, 145, 1062572, true, true ); /* <U><CENTER>Another player is harassing me (or Exploiting).</CENTER></U><BR>
																		 ...
																		 * <A HREF="http://www.freebb.com/index.php?freebb=legends">– what is verbal harassment? -</A>
																		 ...
																		 * <A HREF="http://www.freebb.com/index.php?freebb=legends">- How do I ignore a player?</A><BR>
																		 ...
																		 * <A HREF="http://www.freebb.com/index.php?freebb=legends">– What constitutes an exploit?</a>
																		 */
			...
			AddHtmlLocalized( 110, 240, 450, 145, 1062573, true, true ); /* <U><CENTER>Another player is harassing me using game mechanics.</CENTER></U><BR>
																		  ...
																		  * Before you submit a complaint be sure you understand what constitutes harassment
																		  * <A HREF="http://www.freebb.com/index.php?freebb=legends"> – what is physical harassment?</A>
																		  * and that you have followed these steps:<BR>
																		  * 1. You have asked the player to stop and they have continued.<BR>
																		  * 2. You have tried to remove yourself from the situation.<BR>
																		  * 3. You have done nothing to instigate or further encourage the harassment.<BR>
