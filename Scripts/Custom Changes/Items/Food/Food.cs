...
namespace Server.Items
{
	public abstract class Food : Item
	{
		...
		static public bool FillHunger( Mobile from, int fillFactor )
		{
			if ( from.Hunger >= 20 )
			{
				from.SendAsciiMessage( "You are simply too full to eat any more!" );
				return false;
			}
			...
			{
				from.Hunger = 20;
				from.SendAsciiMessage( "You manage to eat the food, but you are stuffed!" );
			}
			else
			{
				from.Hunger = iHunger;
				...
				if ( iHunger < 5 )
					from.SendAsciiMessage( "You eat the food, but are still extremely hungry." );
				else if ( iHunger < 10 )
					from.SendAsciiMessage( "You eat the food, and begin to feel more satiated." );
				else if ( iHunger < 15 )
					from.SendAsciiMessage( "After eating the food, you feel much less hungry." );
				else
					from.SendAsciiMessage( "You feel quite full after consuming the food." );
			}
	...
	public class BreadLoaf : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " bread loaves" );
				}
				else
				{
					LabelTo( from, "a loaf of bread" );
				}
			}
			else
			{
	...
	public class Bacon : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " slices of bacon" );
				}
				else
				{
					LabelTo( from, "a slice of bacon" );
				}
			}
			else
			{
	...
	public class FishSteak : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " fish steaks" );
				}
				else
				{
					LabelTo( from, "a fish steak" );
				}
			}
			else
			{
	...
	public class CheeseWheel : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " wheels of cheese" );
				}
				else
				{
	...
	public class CheeseWedge : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " wedges of cheese" );
				}
				else
				{
	...
	public class FrenchBread : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " french bread loaves" );
				}
				else
				{
					LabelTo( from, "a french bread loaf" );
				}
			}
			else
			{
	...
	public class FriedEggs : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " fried eggs" );
				}
				else
				{
					LabelTo( from, "fried eggs" );
				}
			}
			else
			{
	...
	public class CookedBird : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " cooked birds" );
				}
				else
				{
					LabelTo( from, "a cooked bird" );
				}
			}
			else
			{
	...
	public class RoastPig : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " roast pigs" );
				}
				else
				{
	...
	public class Sausage : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " sausages" );
				}
				else
				{
					LabelTo( from, "a sausage" );
				}
			}
			else
			{
	...
	public class Ribs : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " cuts of ribs" );
				}
				else
				{
					LabelTo( from, "a cut of ribs" );
				}
			}
			else
			{
	...
	public class LambLeg : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " legs of lamb" );
				}
				else
				{
					LabelTo( from, "a leg of lamb" );
				}
			}
			else
			{
	...
	public class ChickenLeg : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " chicken legs" );
				}
				else
				{
					LabelTo( from, "a chicken leg" );
				}
			}
			else
			{
	...
	public class HoneydewMelon : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " honeydew melons" );
				}
				else
				{
					LabelTo( from, "a honeydew melon" );
				}
			}
			else
			{
	...
	public class YellowGourd : Food
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " gourds" );
				}
				else
				{
					LabelTo( from, "a gourd" );
				}
			}
			else
			{
