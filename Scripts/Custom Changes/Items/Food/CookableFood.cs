...
namespace Server.Items
{
		...
		private class InternalTarget : Target
		{
			...
			private class InternalTimer : Timer
			{
				...
				protected override void OnTick()
				{
					...
					{
						m_From.SendAsciiMessage( "You burn the food to a crisp! It's ruined." );
						return;
					}
	...
	public class RawRibs : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " cuts of raw ribs" );
				}
				else
				{
	...
	public class RawLambLeg : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " raw legs of lamb" );
				}
				else
				{
					LabelTo( from, "a raw leg of lamb" );
				}
			}
			else
			{
	...
	public class RawChickenLeg : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " raw chicken legs" );
				}
				else
				{
					LabelTo( from, "a raw chicken leg" );
				}
			}
			else
			{
	...
	public class RawBird : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " raw birds" );
				}
				else
				{
	...
	public class UnbakedPeachCobbler : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "unbaked peach cobbler" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UnbakedFruitPie : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an unbaked fruit pie" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UnbakedMeatPie : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an unbaked meatpie" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UnbakedPumpkinPie : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an unbaked pumpkin pie" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UnbakedApplePie : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an unbaked apple pie" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UncookedCheesePizza : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an uncooked cheese pizza" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UncookedSausagePizza : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an uncooked sausage pizza" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UncookedPizza : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an uncooked pizza" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class UnbakedQuiche : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "an unbaked quiche" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class RawFishSteak : CookableFood
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				if ( this.Amount > 1 )
				{
					LabelTo( from, this.Amount + " raw fish steaks" );
				}
				else
				{
					LabelTo( from, "a raw fish steak" );
				}
			}
			else
			{
