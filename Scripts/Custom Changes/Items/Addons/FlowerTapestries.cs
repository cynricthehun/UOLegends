...
namespace Server.Items
{
	...
	public class LightFlowerTapestryEastDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a flower tapestry deed facing east" );
			}
			else
			{
	...
	public class LightFlowerTapestrySouthDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a flower tapestry deed facing south" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class DarkFlowerTapestryEastDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a dark flower tapestry deed facing east" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class DarkFlowerTapestrySouthDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a dark flower tapestry deed facing south" );
			}
			else
			{
				LabelTo( from, this.Name );
