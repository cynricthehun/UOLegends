...
namespace Server.Items
{
	...
	public class TrainingDummy : AddonComponent
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( weapon is BaseRanged )
				SendAsciiMessageTo( from, "You can't practice ranged weapons on this." );
				...
				SendAsciiMessageTo( from, "Your skill cannot improve any further by simply practicing with a dummy." );
	...
	public class TrainingDummyEastDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a training dummy deed facing east" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class TrainingDummySouthDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a training dummy deed facing south" );
			}
			else
			{
				LabelTo( from, this.Name );
