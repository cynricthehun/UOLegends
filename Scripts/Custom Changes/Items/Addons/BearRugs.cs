...
namespace Server.Items
{
	...
	public class BrownBearRugEastDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a brown bear rug deed facing east" );
			}
			else
			{
	...
	public class BrownBearRugSouthDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a brown bear rug deed facing south" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class PolarBearRugEastDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a polar bear rug deed facing east" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class PolarBearRugSouthDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a polar bear rug deed facing south" );
			}
			else
			{
				LabelTo( from, this.Name );
