...
namespace Server.Items
{
	...
	public class SmallStretchedHideEastDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a small stretched hide deed facing east" );
			}
			else
			{
	...
	public class SmallStretchedHideSouthDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a small stretched hide deed facing south" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class MediumStretchedHideEastDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a medium stretched hide deed facing east" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class MediumStretchedHideSouthDeed : BaseAddonDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a medium stretched hide deed facing south" );
			}
			else
			{
				LabelTo( from, this.Name );
