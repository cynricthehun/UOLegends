...
namespace Server.Items
{
	public class LeatherDyeTub : DyeTub, Engines.VeteranRewards.IRewardItem
	{
		...
		public override string TargetMessage{ get{ return "Select the leather item to dye."; } } 
		public override string FailMessage{ get{ return "You can only dye leather with this tub."; } }
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a leather dye tub" );
			}
			else
			{
