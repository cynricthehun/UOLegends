...
namespace Server.Items
{
	public class StatuetteDyeTub : DyeTub, Engines.VeteranRewards.IRewardItem
	{
		...
		public override string TargetMessage{ get{ return "Target the statuette to dye."; } }
		public override string FailMessage{ get{ return "You can only dye veteran reward statuettes with this tub."; } }
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a statuette dye tub" );
			}
			else
			{
