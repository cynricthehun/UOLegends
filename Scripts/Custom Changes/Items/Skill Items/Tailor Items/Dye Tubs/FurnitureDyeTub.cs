...
namespace Server.Items
{
	public class FurnitureDyeTub : DyeTub, Engines.VeteranRewards.IRewardItem
	{
		...
		public override string TargetMessage{ get{ return "Select the furniture to dye."; } }
		public override string FailMessage{ get{ return "That is not a piece of furniture."; } }
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a furniture dye tub" );
			}
			else
			{
