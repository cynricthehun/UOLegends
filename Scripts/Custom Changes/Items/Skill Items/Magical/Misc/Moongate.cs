...
namespace Server.Items
{
	...
	public class Moongate : Item
	{
		...
		public virtual void UseGate( Mobile m )
		{
			...
			{
				m.SendAsciiMessage( "You can't do that while carrying the sigil." );
			}
			else if ( m_TargetMap == Map.Felucca && m is PlayerMobile && ((PlayerMobile)m).Young )
			{
				m.SendAsciiMessage( "You decide against traveling to Felucca while you are still young." );
			}
			...
			{
				m.SendAsciiMessage( "You are not allowed to travel there." );
			}
