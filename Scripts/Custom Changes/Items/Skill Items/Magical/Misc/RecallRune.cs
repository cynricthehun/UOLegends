...
namespace Server.Items
{
	...
	public class RecallRune : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				message = "That must be in your pack for you to use it.";
			}
			else if ( House != null )
			{
				message = "You cannot edit the description for this rune.";
			}
			else if ( m_Marked )
			{
				message = "Please enter a description for this marked object.";

				from.Prompt = new RenamePrompt( this );
			}
			else
			{
				message = "That rune is not yet marked.";
			}
		...
		private class RenamePrompt : Prompt
		{
			...
			public override void OnResponse( Mobile from, string text )
			{
				if ( m_Rune.House == null && m_Rune.Marked )
				{
					...
					from.SendAsciiMessage( "The etching on the rune has been changed." );
				}
			}
		}
