...
namespace Server.Items
{
	public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable
	{
		...
		private string m_Drb;
		private string m_Dmg;
		...
		public override bool CanEquip( Mobile from )
		{
			...
			{
				from.SendAsciiMessage( "You are not strong enough to equip that." );
				return false;
			}
			...
			switch ( version )
			{
				...
				case 5:
				{
					...
					if ( GetSaveFlag( flags, SaveFlag.DamageLevel ) )
					{
						...
						if ( m_DamageLevel > WeaponDamageLevel.Vanquishing )
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( m_AccuracyLevel != WeaponAccuracyLevel.Regular )
			{
				if ( m_AccuracyLevel == WeaponAccuracyLevel.Accurate )
					m_Acc = "accurate";
				if ( m_AccuracyLevel == WeaponAccuracyLevel.Surpassingly )
					m_Acc = "surpassingly accurate";
				if ( m_AccuracyLevel == WeaponAccuracyLevel.Eminently )
					m_Acc = "eminently accurate";
				if ( m_AccuracyLevel == WeaponAccuracyLevel.Exceedingly )
					m_Acc = "exeedingly accurate";
				if ( m_AccuracyLevel == WeaponAccuracyLevel.Supremely )
					m_Acc = "supremely accurate";	 
			}
			if ( m_DamageLevel != WeaponDamageLevel.Regular )
			{
				if ( m_DamageLevel == WeaponDamageLevel.Ruin )
					m_Dmg = "ruin";
				if ( m_DamageLevel == WeaponDamageLevel.Might )
					m_Dmg = "might";
				if ( m_DamageLevel == WeaponDamageLevel.Force )
					m_Dmg = "force";
				if ( m_DamageLevel == WeaponDamageLevel.Power )
					m_Dmg = "power";
				if ( m_DamageLevel == WeaponDamageLevel.Vanquishing )
					m_Dmg = "vanquishing";
			}
			if ( m_DurabilityLevel != WeaponDurabilityLevel.Regular )
			{
				if ( m_DurabilityLevel == WeaponDurabilityLevel.Durable )
					m_Drb = "durable";
				if ( m_DurabilityLevel == WeaponDurabilityLevel.Substantial )
					m_Drb = "substantial";
				if ( m_DurabilityLevel == WeaponDurabilityLevel.Massive )
					m_Drb = "massive";
				if ( m_DurabilityLevel == WeaponDurabilityLevel.Fortified )
					m_Drb = "fortified";
				if ( m_DurabilityLevel == WeaponDurabilityLevel.Indestructible )
					m_Drb = "indestructible";
			}
			if ( m_Slayer != SlayerName.None )
			{
			...
			if ( m_Slayer != SlayerName.None || m_DurabilityLevel != WeaponDurabilityLevel.Regular || m_DamageLevel != WeaponDamageLevel.Regular || m_AccuracyLevel != WeaponAccuracyLevel.Regular || m_PoisonCharges > 0 )
			{
				if ( this.Identified == true )
				{
					if ( m_Slayer != SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison == null )
					{
						LabelTo( from, "({0})", m_Slr );
					}
					if ( m_Slayer == SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison == null )
					{
						LabelTo( from, "({0})", m_Drb );
					}
					if ( m_Slayer == SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison == null )
					{
						LabelTo( from, "({0})", m_Dmg );
					}
					if ( m_Slayer == SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison == null )
					{
							LabelTo( from, "({0})", m_Acc );
					}
					/*if ( m_Slayer == SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
							LabelTo( from, "(poison charges:{0})", this.PoisonCharges );
						}
					}*/
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison == null )
					{
						LabelTo( from, "({0}/{1})", m_Slr, m_Drb );
					}
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison == null )
					{
						LabelTo( from, "({0}/{1})", m_Slr, m_Dmg );
					}
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison == null )
					{
							LabelTo( from, "({0}/{1})", m_Slr, m_Acc );
					}
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
							LabelTo( from, "({0}/poison charges:{1})", m_Slr, this.PoisonCharges );
						}
						else
						{
							LabelTo( from, "({0})", m_Slr );
					...
					{
						LabelTo( from, "({0}/{1}/{2})", m_Slr, m_Drb, m_Dmg );
					}
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison == null )
					{
							LabelTo( from, "({0}/{1}/{2}/{3})", m_Slr, m_Drb, m_Dmg, m_Acc );
					}
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
								LabelTo( from, "({0}/{1}/{2}/{3}/poison charges:{4})", m_Slr, m_Drb, m_Dmg, m_Acc, this.PoisonCharges );
						}
						else
						{
								LabelTo( from, "({0}/{1}/{2}/{3})", m_Slr, m_Drb, m_Dmg, m_Acc );
					...
					{
							LabelTo( from, "({0}/{1}/{2})", m_Slr, m_Dmg, m_Acc );
					}
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
								LabelTo( from, "({0}/{1}/{2}/poison charges:{3})", m_Slr, m_Dmg, m_Acc, PoisonCharges );
						}
						else
						{
								LabelTo( from, "({0}/{1}/{2})", m_Slr, m_Dmg, m_Acc );
					...
					{
							LabelTo( from, "({0}/{1}/{2})", m_Slr, m_Drb, m_Acc );
					}
					else if ( m_Slayer != SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
								LabelTo( from, "({0}/{1}/poison charges:{2})", m_Slr, m_Acc, this.PoisonCharges );
						}
						else
						{
								LabelTo( from, "({0}/{1})", m_Slr, m_Acc );
					...
					{
						LabelTo( from, "({0}/{1})", m_Drb, m_Dmg );
					}
					else if ( m_Slayer == SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison == null )
					{
							LabelTo( from, "({0}/{1})", m_Drb, m_Acc );
					}
					else if ( m_Slayer == SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
							LabelTo( from, "({0}/poison charges:{1})", m_Drb, this.PoisonCharges );
						}
						else
						{
							LabelTo( from, "({0})", m_Drb );
					...
					{
							LabelTo( from, "({0}/{1}/{2})", m_Drb, m_Dmg, m_Acc );
					}
					else if ( m_Slayer == SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
								LabelTo( from, "({0}/{1}/{2}/poison charges:{3})", m_Drb, m_Dmg, m_Acc, this.PoisonCharges );
						}
						else
						{
								LabelTo( from, "({0}/{1}/{2})", m_Drb, m_Dmg, m_Acc );
					...
					else if ( m_Slayer == SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
							LabelTo( from, "({0}/{1}/poison charges:{2})", m_Drb, m_Dmg, this.PoisonCharges );
						}
						else
						{
							LabelTo( from, "({0}/{1})", m_Drb, m_Dmg );
					...
					else if ( m_Slayer == SlayerName.None && m_DurabilityLevel != WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
								LabelTo( from, "({0}/{1}/poison charges:{2})", m_Drb, m_Acc, this.PoisonCharges );
						}
						else
						{
								LabelTo( from, "({0}/{1})", m_Drb, m_Acc );
					...
					if ( m_Slayer == SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison == null )
					{
						LabelTo( from, "({0}/{1})", m_Dmg, m_Acc );
					}
					if ( m_Slayer == SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
								LabelTo( from, "({0}/{1}/poison charges:{2})", m_Dmg, m_Acc, this.PoisonCharges );
						}
						else
						{
								LabelTo( from, "({0}/{1})", m_Dmg, m_Acc );
					...
					if ( m_Slayer == SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel != WeaponDamageLevel.Regular && m_AccuracyLevel == WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
							LabelTo( from, "({0}/poison charges:{1})", m_Dmg, this.PoisonCharges );
						}
						else
						{
							LabelTo( from, "({0})", m_Dmg );
					...
					if ( m_Slayer == SlayerName.None && m_DurabilityLevel == WeaponDurabilityLevel.Regular && m_DamageLevel == WeaponDamageLevel.Regular && m_AccuracyLevel != WeaponAccuracyLevel.Regular && m_Poison != null )
					{
						if ( this.PoisonCharges > 0 )
						{
								LabelTo( from, "({0}/poison charges:{1})", m_Acc, this.PoisonCharges );
						}
						else
						{
								LabelTo( from, "({0})", m_Acc );
