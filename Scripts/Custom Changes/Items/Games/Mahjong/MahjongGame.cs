	...
	public class MahjongGame : Item, ISecurable
	{
		...
		public bool ShowScores
		{
			...
			set
			{
				...
				//m_Players.SendAsciiMessage( value ? "The dealer has enabled score display." : "The dealer has disabled score display." );
			}
		}
		...
		public bool SpectatorVision
		{
			...
			set
			{
				...
				//m_Players.SendAsciiMessage( value ? "The dealer has enabled Spectator Vision." : "The dealer has disabled Spectator Vision." );
		...
		public void ResetGame( Mobile from )
		{
			...
			if ( from != null )
				//m_Players.SendAsciiMessage( from.Name + " has reset the game." );
		...
		public void ResetWalls( Mobile from )
		{
			...
			//if ( from != null )
				//m_Players.SendAsciiMessage( "The dealer rebuilds the wall." );
		}
