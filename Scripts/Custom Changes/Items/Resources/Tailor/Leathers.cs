...
namespace Server.Items
{
	...
	public class Leather : BaseLeather
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Amount > 1 )
			{
				LabelTo( from, this.Amount + " pieces of leather" );
			}
			else
			{
				LabelTo( from, "a piece of leather" );
			}
		}
	...
	public class SpinedLeather : BaseLeather
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Amount > 1 )
			{
				LabelTo( from, this.Amount + " pieces of spined leather" );
			}
			else
			{
				LabelTo( from, "a piece of spined leather" );
			}
		}
	...
	public class HornedLeather : BaseLeather
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Amount > 1 )
			{
				LabelTo( from, this.Amount + " pieces of horned leather" );
			}
			else
			{
				LabelTo( from, "a piece of horned leather" );
			}
		}
	...
	public class BarbedLeather : BaseLeather
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Amount > 1 )
			{
				LabelTo( from, this.Amount + " pieces of barbed leather" );
			}
			else
			{
				LabelTo( from, "a piece of barbed leather" );
			}
		}
