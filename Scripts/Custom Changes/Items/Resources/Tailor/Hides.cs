...
namespace Server.Items
{
		...
		public override void OnSingleClick( Mobile from )
			{
				if ( this.Amount > 1 )
				{
				LabelTo( from, this.Amount + " piles of hides" );
				}
				else
				{
	...
	public class SpinedHides : BaseHides, IScissorable
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Amount > 1 )
			{
				LabelTo( from, this.Amount + " piles of spined hides" );
			}
			else
			{
				LabelTo( from, "a pile of spined hides" );
			}
		}
	...
	public class HornedHides : BaseHides, IScissorable
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Amount > 1 )
			{
				LabelTo( from, this.Amount + " piles of horned hides" );
			}
			else
			{
				LabelTo( from, "a pile of horned hides" );
			}
		}
	...
	public class BarbedHides : BaseHides, IScissorable
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Amount > 1 )
			{
				LabelTo( from, this.Amount + " piles of barbed hides" );
			}
			else
			{
				LabelTo( from, "a pile of barbed hides" );
			}
		}
