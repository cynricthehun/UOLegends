		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name  == null )
			{
				if ( this.Identified == true || ( this.Durability == ArmorDurabilityLevel.Regular && this.ProtectionLevel == ArmorProtectionLevel.Regular ) )
				{
					...
					{
						LabelTo( from, "a blessed wooden shield" );
					}
					else if ( this.Quality == ArmorQuality.Exceptional )
					{
						if ( this.LootType != LootType.Blessed )
						{
							...
							{
								LabelTo( from, "an exceptional wooden shield" );
							}
							else
							{
								LabelTo( from, "an exceptional wooden shield (crafted by:" + this.Crafter.Name + ")" );
							}
						}
						if ( this.LootType == LootType.Blessed )
						{
							if ( this.Crafter == null )
							{
								LabelTo( from, "a blessed, exceptional wooden shield" );
							}
							else
							{
								LabelTo( from, "a blessed, exceptional wooden shield (crafted by:" + this.Crafter.Name + ")" );
							}
						}
					}
				}
				...
				{
					LabelTo( from, "a magic wooden shield" );
				}
