...
/* Recall From */	              { true,		true,			true,		false,		true,			true,			false,		false,				false,				false,				false },
/* Recall To */		{ true,		true,			false,		false,		true,			false,			false,		false,				false,				false,				false },
/* Gate From */		{ true,		true,			false,		false,		true,			false,			false,		false,				false,				false,				false },
/* Gate To */		{ true,		true,			false,		false,		true,			false,			false,		false,				false,				false,				false },
/* Mark In */		{ true,		true,			false,		false,		true,			false,			false,		false,				false,				false,				false },
/* Tele From */		{ true,		true,			true,		true,		true,			true,			true,		false,				true,				true,				true },
/* Tele To */		{ true,		true,			true,		true,		true,			true,			true,		false,				true,				false,				true },
			};
		...
		public static bool CheckTown( Point3D loc, Mobile caster )
		{
			...
			{
				caster.SendAsciiMessage( "You cannot cast this in town!" );
				return false;
			}
