...
namespace Server.Spells.Fourth
{
	public class RecallSpell : Spell
	{
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendAsciiMessage( 0x22, "Thou art too encumbered to move." );
				return false;
			}
		...
		public void Effect( Point3D loc, Map map, bool checkMulti )
		{
			...
			{
				Caster.SendAsciiMessage( "You can not recall to another facet." );
			}
			...
			{
				Caster.SendAsciiMessage( "There are no charges left on that item." );
			}
			...
			protected override void OnTarget( Mobile from, object o )
			{
				...
				else if ( o is Runebook )
				{
					...
					if ( e != null )
						...
						from.SendAsciiMessage( "Target is not marked." );
				}
