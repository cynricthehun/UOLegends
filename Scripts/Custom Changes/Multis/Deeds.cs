...
namespace Server.Multis.Deeds
{
	...
	public abstract class HouseDeed : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendAsciiMessage( "House placement cancellation could result in a 60 second delay in the return of your deed." );
	...
	public class StonePlasterHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a stone-and-plaster house" );
			}
			else
			{
	...
	public class FieldStoneHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a field stone house" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class SmallBrickHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a small brick house" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class WoodHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a wooden house" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class WoodPlasterHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a wood-and-plaster house" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class ThatchedRoofCottageDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a thatched-roof cottage" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class BrickHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a brick house" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class TwoStoryWoodPlasterHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a two-story wood-and-plaster house" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class TwoStoryStonePlasterHouseDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a two-story stone-and-plaster house" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class TowerDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a tower" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class CastleDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a castle" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class LargePatioDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a large house with patio" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class LargeMarbleDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a large marble house with patio" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class SmallTowerDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a small stone tower" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class LogCabinDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a two story log cabin" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class SandstonePatioDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a sandstone house with patio" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class VillaDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a two story villa" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class StoneWorkshopDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a small stone workshop" );
			}
			else
			{
				LabelTo( from, this.Name );
	...
	public class MarbleWorkshopDeed : HouseDeed
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( this.Name == null )
			{
				LabelTo( from, "a deed to a small marble workshop" );
			}
			else
			{
				LabelTo( from, this.Name );
