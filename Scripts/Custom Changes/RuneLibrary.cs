...
{
	public class RuneLibrary : Item
	{
		private static string pathlist = "Data/TMaps.txt";
      ...
      {
         Server.Commands.Register( "RuneLibrary", AccessLevel.Administrator, new CommandEventHandler( RuneLibrary_OnCommand ) );
      }
		...
		[Constructable]
		public RuneLibrary (Mobile from)
		{
		...
		public RuneLibrary( Serial serial ) : base( serial )
		{
		}
