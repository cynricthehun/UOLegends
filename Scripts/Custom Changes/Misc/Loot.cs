...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_JewelryTypes = new Type[]
			{
				typeof( GoldRing ),		typeof( GoldBracelet ),		typeof( GoldEarrings ),		typeof( GoldNecklace ),		typeof( Necklace ),	typeof( SilverBeadNecklace ),
				typeof( SilverRing ),		typeof( SilverBracelet ),	typeof( SilverEarrings ),	typeof( SilverNecklace ),	typeof( GoldBeadNecklace )
			};
