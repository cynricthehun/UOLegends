	...
	public class CharacterCreation
	{
		...
		private static void FillBankbox( Mobile m )
		{
			...
			if ( bank != null )
			{
				...
				bank.DropItem( MakeNewbie( new SewingKit( 100 ) ) );
				bank.DropItem( MakeNewbie( new SmithHammer( 100 ) ) );
				bank.DropItem( MakeNewbie( new FletcherTools( 100 ) ) );
				bank.DropItem( MakeNewbie( new DovetailSaw( 100 ) ) );
				bank.DropItem( MakeNewbie( new MortarPestle( 100 ) ) );
				bank.DropItem( MakeNewbie( new ScribesPen( 100 ) ) );
				bank.DropItem( MakeNewbie( new TinkerTools( 100 ) ) );
				...
				// Resources
				bank.DropItem( MakeNewbie( new Feather( 100 ) ) );
				bank.DropItem( MakeNewbie( new BoltOfCloth( 100 ) ) );
				bank.DropItem( MakeNewbie( new BlankScroll( 100 ) ) );
				bank.DropItem( MakeNewbie( new Hides( 100 ) ) );
				bank.DropItem( MakeNewbie( new Bandage( 100 ) ) );
				bank.DropItem( MakeNewbie( new Bottle( 100 ) ) );
				bank.DropItem( MakeNewbie( new Log( 100 ) ) );

				bank.DropItem( MakeNewbie( new IronIngot( 500 ) ) );

				// Reagents
				bank.DropItem( MakeNewbie( new BlackPearl( 100 ) ) );
				bank.DropItem( MakeNewbie( new Bloodmoss( 100 ) ) );
				bank.DropItem( MakeNewbie( new Garlic( 100 ) ) );
				bank.DropItem( MakeNewbie( new Ginseng( 100 ) ) );
				bank.DropItem( MakeNewbie( new MandrakeRoot( 100 ) ) );
				bank.DropItem( MakeNewbie( new Nightshade( 100 ) ) );
				bank.DropItem( MakeNewbie( new SulfurousAsh( 100 ) ) );
				bank.DropItem( MakeNewbie( new SpidersSilk( 100 ) ) );

				// Some extra starting gold
				bank.DropItem( MakeNewbie( new Gold( 4000 ) ) );

				// 10 blank recall runes
				for ( int i = 0; i < 10; ++i )
		...
		private static void EventSink_CharacterCreated( CharacterCreatedEventArgs args )
		{
			...
			if( ((Account)args.Account)[1] == null )
				FillBankbox( newChar );
