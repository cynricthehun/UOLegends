...
namespace Server.Items.MusicBox
{
    ...
    public class MusicBox : Item
    {
		...
		{
            Server.Commands.Register("AddAllSongs", AccessLevel.GameMaster, new CommandEventHandler(AddAllSongs_OnCommand)); 
		}
...
MusicName.OldUlt02, MusicName.Serpents, MusicName.Britain1, MusicName.Approach, MusicName.Combat2,
            MusicName.Britain2, MusicName.Bucsden, MusicName.Jhelom, MusicName.LBCastle, MusicName.Magincia,

MusicName.Minoc, MusicName.Create1, MusicName.Death, MusicName.DragFlit, MusicName.Forest_a,

MusicName.Ocllo, MusicName.Samlethe, MusicName.Skarabra, MusicName.Trinsic, MusicName.Vesper, 

MusicName.Wind, MusicName.Yew, MusicName.Cave01, MusicName.Dungeon9, MusicName.Sailing,

MusicName.Tavern01, MusicName.Tavern02, MusicName.Stones2, MusicName.Swamp_a, MusicName.Victory,

MusicName.Tavern03, MusicName.Tavern04, MusicName.Combat3, MusicName.Combat1, MusicName.InTown01,

MusicName.BTCastle, MusicName.Nujelm, MusicName.Dungeon2, MusicName.Cove, MusicName.Moonglow,

MusicName.TokunoDungeon, MusicName.Jungle_a, MusicName.Linelle, MusicName.Mountn_a, MusicName.OldUlt01,

MusicName.OldUlt03, MusicName.OldUlt04, MusicName.OldUlt05, MusicName.OldUlt06, MusicName.Plains_a,
...
MusicName.Zento
    ...
    public class PlayListGump : Gump
    {
            ...
            : base(30, 30)
        {
            ...
            AddPage(0);
            AddHtmlLocalized(250, 10, 180, 20, 1075131, 2124, false, false);
            int Xpos = 26, Ypos = 42;
            int z = 0;
            for (int x = 0; x < 3; x++)
            {
