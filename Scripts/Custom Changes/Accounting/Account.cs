...
namespace Server.Accounting
{
	public class Account : IAccount
	{
		...
		public void RemoveYoungStatus( string message )
		{
			this.Young = false;
			...
			for ( int i = 0; i < m_Mobiles.Length; i++ )
			{
				...
				if ( m != null && m.Young )
				{
					...
					if ( m.NetState != null )
					{
						...
						m.SendAsciiMessage( "You are no longer considered a young player of Ultima Online, and are no longer subject to the limitations and benefits of being in that caste." ); // You are no longer considered a young player of Ultima Online, and are no longer subject to the limitations and benefits of being in that caste.
					}
				}
			}
		}
		...
		public void CheckYoung()
		{
			if ( TotalGameTime >= YoungDuration )
				RemoveYoungStatus( "You are old enough to be considered an adult, and have outgrown your status as a young player!" ); // 
		}
