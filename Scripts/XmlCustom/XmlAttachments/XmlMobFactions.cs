    ...
    public class XmlMobFactions : XmlAttachment
    {
		...
		private static Type[] ArachnidMembers =
				new Type[]
				{
				    ...
				    typeof( Scorpion ), typeof( Mephitis )
				};
		...
		private static Type[] AbyssMembers =
				new Type[]
				{
                    ...
                    typeof( StoneGargoyle ), typeof(HellHound)
				};
        ...
        public static new void Initialize()
        {
            ...
            Server.Commands.Register( "VerboseMobFactions", AccessLevel.Player, new CommandEventHandler( VerboseMobFactions_OnCommand ) );
            Server.Commands.Register( "AddAllMobFactions", AccessLevel.Administrator, new CommandEventHandler( AddAllMobFactions_OnCommand ) );
            Server.Commands.Register( "RemoveAllMobFactions", AccessLevel.Administrator, new CommandEventHandler( RemoveAllMobFactions_OnCommand ) );
            Server.Commands.Register( "CheckMobFactions", AccessLevel.Player, new CommandEventHandler( CheckMobFactions_OnCommand ) );
