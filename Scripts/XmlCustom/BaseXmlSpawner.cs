...
namespace Server.Mobiles
{
	...
	public class BaseXmlSpawner
	{
		...
		private static string InternalGetValue(object o, PropertyInfo p, int index)
		{
			...
			if (type.IsArray)
			{
				// array.GetLowerBound and array.GetUpperBound to do a bounds check
				try
				{
					object arrayvalue = p.GetValue(o, null);

					int lower = ((Array)arrayvalue).GetLowerBound(0);
					int upper = ((Array)arrayvalue).GetUpperBound(0);
					if (index <= lower && index <= upper)
						value = ((Array)arrayvalue).GetValue(index);
				}
				catch { }
			}
			else
			...
			if (IsEnum(type))
			{
				...
				else if (type.IsArray)
				{
					try
					{
						...
						object po = ((Array)arrayvalue).GetValue(0);
		...
		public static string InternalSetValue(Mobile from, object o, PropertyInfo p, string value, bool shouldLog, int index)
		{
			...
			try
			{
				...
				if (ptype.IsArray)
				{
					...
					if (index <= lower && index <= upper)
						((Array)arrayvalue).SetValue(toSet, index);
					else
		...
		public static string GetBasicPropertyValue(object o, string propname, out Type ptype)
		{
			...
			foreach (PropertyInfo p in props)
			{
				...
				if (Insensitive.Equals(p.Name, propname))
				{
					...
					string value = InternalGetValue(o, p, 0);
				...
				if (plookup != null)
				{
					...
					if (ptype.IsArray)
					{
						try
						{
							...
							if (index <= lower && index <= upper)
								po = ((Array)arrayvalue).GetValue(index);
						}
						catch { }
					}
					else
				...
				if (arglist.Length > 1)
				{
						...
						arglist[0].Length > 0 && !Char.IsUpper(arglist[0][0]))
					{
						...
						//else
						{
							...
							{
								string result = SetPropertyValue(spawner, o, arglist[0], singlearglist[1].Remove(0, 1));
						...
						if (IsValuemodKeyword(value_keywordargs[0]))
						{
							...
							if (kw == valuemodKeyword.RND)
							{
								...
								if (kw == valuemodKeyword.RNDBOOL)
								{
									...
									if (kw == valuemodKeyword.RNDLIST || kw == valuemodKeyword.RNDSTRLIST)
									{
										...
										if (kw == valuemodKeyword.MY)
										{
											...
											if (kw == valuemodKeyword.GET)
											{
												...
												if (kw == valuemodKeyword.GETVAR)
												{
													...
													if (kw == valuemodKeyword.GETONMOB)
													{
														...
														if (kw == valuemodKeyword.GETONCARRIED)
														{
															...
															if (kw == valuemodKeyword.GETONTRIGMOB)
															{
																...
																if (kw == valuemodKeyword.GETONPARENT)
																{
																	...
																	if (kw == valuemodKeyword.GETONTHIS)
																	{
							...
							if (kw == valuemodKeyword.GETONTAKEN)
							{
								...
								if (kw == valuemodKeyword.GETONGIVEN)
								{
									...
									if (kw == valuemodKeyword.GETONSPAWN)
									{
										...
										if (kw == valuemodKeyword.GETFROMFILE)
										{
												...
												if (kw == valuemodKeyword.INC)
												{
													...
													if (kw == valuemodKeyword.MOB)
													{
														...
														if (kw == valuemodKeyword.TRIGMOB)
														{
															...
															if (kw == valuemodKeyword.AMOUNTCARRIED)
															{
																...
																if (kw == valuemodKeyword.PLAYERSINRANGE)
																{
																	...
																	if (kw == valuemodKeyword.TRIGSKILL)
																	{
																		if (value_keywordargs.Length > 1)
																		{
																		...
																		if (kw == valuemodKeyword.RANDNAME)
																		{
																			if (value_keywordargs.Length > 1)
																			{
							...
							if (IsTypemodKeyword(keywordargs[0]))
							{
																			...
																			if (kw == typemodKeyword.SPEECH)
																			{
																				...
																				if (kw == typemodKeyword.OFFSET)
																				{
																					...
																					if (kw == typemodKeyword.ANIMATE)
																					{
																						...
																						if (kw == typemodKeyword.BCAST)
																						{
																							// broadcast a message to all players
																							CommandHandlers.BroadcastMessage(AccessLevel.Player, 0x482, arglist[1]);
								...
								if ((kw == valueKeyword.GETONMOB) && arglist.Length > 2)
								{
									...
									if ((kw == valueKeyword.GET) && arglist.Length > 2)
									{
										...
										if ((kw == valueKeyword.GETONCARRIED) && arglist.Length > 2)
										{
											...
											if ((kw == valueKeyword.GETONTRIGMOB) && arglist.Length > 1)
											{
												// syntax is GETONTRIGMOB,property
												...
												if ((kw == valueKeyword.GETVAR) && arglist.Length > 1)
												{
													// syntax is GETVAR,varname
													...
													if ((kw == valueKeyword.GETONPARENT) && arglist.Length > 1)
													{
														// syntax is GETONPARENT,property
														...
														if ((kw == valueKeyword.GETONGIVEN) && arglist.Length > 1)
														{
															// syntax is GETONGIVEN,property
															...
															if ((kw == valueKeyword.GETONTAKEN) && arglist.Length > 1)
															{
																// syntax is GETONTAKEN,property
																...
																if ((kw == valueKeyword.GETONTHIS) && arglist.Length > 1)
																{
																	// syntax is GETONTHIS,property
																	...
																	if ((kw == valueKeyword.GETONSPAWN) && arglist.Length > 2)
																	{
																		...
																		if ((kw == valueKeyword.GETFROMFILE) && arglist.Length > 1)
																		{
																			// syntax is GETFROMFILE,filename
																			ptype = typeof(string);
																			...
																			if ((kw == valueKeyword.RND) && arglist.Length > 2)
																			{
																				...
																				if ((kw == valueKeyword.RNDBOOL))
																				{
																					...
																					if ((kw == valueKeyword.RNDLIST) && arglist.Length > 1)
																					{
																						...
																						if ((kw == valueKeyword.RNDSTRLIST) && arglist.Length > 1)
																						{
																							...
																							if ((kw == valueKeyword.AMOUNTCARRIED) && arglist.Length > 1)
																							{
																								// syntax is AMOUNTCARRIED,itemtype
																								...
																								if ((kw == valueKeyword.PLAYERSINRANGE) && arglist.Length > 1)
																								{
																									...
																									if ((kw == valueKeyword.TRIGSKILL) && arglist.Length > 1)
																									{
																										if (spawner != null && spawner.TriggerSkill != null)
																										{
																											// syntax is TRIGSKILL,name|value|cap|base
							...
							case itemKeyword.LOOT:
								{
									...
									if (itemkeywordargs.Length == 2)
									{
										...
										if (ltype != null)
										{
											...
											try
											{
												method = ltype.GetMethod(itemkeywordargs[1]);
											}
											catch { }
						...
						if (rangelist != null)
						{
							foreach (Mobile p in rangelist)
							{
								if (!petres && p is PlayerMobile && p.Body.IsGhost)
								{
									...
									if (petres && p is BaseCreature && ((BaseCreature)p).ControlMaster == triggermob && ((BaseCreature)p).Controled && ((BaseCreature)p).IsDeadPet)
									{
	...
	string propertyString, out string status_str)
		...
		public static void AddSpawnItem(XmlSpawner spawner, XmlSpawner.SpawnObject theSpawn, Item item, Point3D location, Map map, Mobile trigmob, bool requiresurface,
			XmlSpawner.SpawnPositionInfo spawnpositioning, string propertyString, out string status_str)
		{
		...
		public static void AddSpawnItem(XmlSpawner spawner, XmlSpawner.SpawnObject theSpawn, Item item, Point3D location, Map map, Mobile trigmob, bool requiresurface,
			XmlSpawner.SpawnPositionInfo spawnpositioning, string propertyString, bool smartspawn, out string status_str)
		{
		...
		*/
		...
		public static bool SpawnTypeKeyword(object invoker, XmlSpawner.SpawnObject TheSpawn,string typeName, string substitutedtypeName, bool requiresurface,
			XmlSpawner.SpawnPositionInfo spawnpositioning, Mobile triggermob, Point3D location, Map map, out string status_str)
		{
		...
		public static bool SpawnTypeKeyword(object invoker, XmlSpawner.SpawnObject TheSpawn,string typeName, string substitutedtypeName, bool requiresurface,
			XmlSpawner.SpawnPositionInfo spawnpositioning, Mobile triggermob, Point3D location, Map map, XmlGumpCallback gumpcallback, out string status_str)
		{
			status_str = null;
			...
			if (IsTypeKeyword(typeName))
			{
				...
				switch (kw)
				{
					...
					case typeKeyword.SETONCARRIED:
						{
							// the syntax is SETONCARRIED,itemname[,itemtype]/prop/value/prop2/value...
							...
							Item testitem = SearchMobileForItem(triggermob, ParseObjectType(itemname), typestr, false);
					...
					case typeKeyword.SETONPARENT:
						{
							...
							if (invoker != null && (invoker is Item))
							{
								...
								if (invoker != null && (invoker is XmlAttachment))
								{
							...
							if (spell != null)
							{
								...
								try
								{
									...
									if (spelltype != null && (spelltargetmethod = spelltype.GetMethod("Target")) != null)
									{
										...
										if (spelltype != null && (spelltargetmethod = spelltype.GetMethod("OnCast")) != null)
										{
									...
									if (spelltargetparms != null && spelltargetparms.Length > 0)
									{
										if (spelltargetparms[0].ParameterType == typeof(Server.Mobile))
										{
											...
											if (spelltargetparms[0].ParameterType == typeof(Server.IPoint3D))
											{
												// set the target parameter
												targetargs = new object[1];
					...
					case typeKeyword.BCAST:
						{
							...
							if (arglist.Length > 1)
							{
								...
								// broadcast a message to all players
								CommandHandlers.BroadcastMessage(AccessLevel.Player, 0x482, msg);
