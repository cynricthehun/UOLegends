...
namespace Server.Items
{
	public abstract class XmlQuestHolder : Container, IXmlQuest
	{
		...
		public XmlQuestHolder( Serial serial ) : base( serial )
		{
		}

		public XmlQuestHolder() :  this( 3643 )
		{
		}

		public XmlQuestHolder( int itemID) :  base( itemID )
		{
			Weight = 0;
			Hue = 500;
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				...
				case 0:
				{
					...
					this.m_ExpirationDuration = reader.ReadDouble();
		...
		private void UpdateWeight()
		{
			...
			if(!PlayerMade || Owner == null || !(RootParent is PlayerMobile))
			{
				TotalWeight = 0;
				TotalGold = 0;
				TotalItems = 0;
