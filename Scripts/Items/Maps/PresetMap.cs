...
namespace Server.Items
{
	public class PresetMap : MapItem
	{
		...
		public override void OnSingleClick( Mobile from )
		{
			...
			if ( m_LabelNumber == 1041189 ) // map of Britain
				LabelTo( from, "a map of Britain" );
			if ( m_LabelNumber == 1041203 ) // map of Britain to Skara Brae
				LabelTo( from, "a map of Britain to Skara Brae" );
			if ( m_LabelNumber == 1041192 ) // map of Britain to Trinsic
				LabelTo( from, "a map of Britaion to Trinsic" );		
			if ( m_LabelNumber == 1041183 ) // map of Buccaneer's Den
				LabelTo( from, "a map of Buccaneer's Den" );
			if ( m_LabelNumber == 1041198 ) // map of Buccaneer's Den to Magincia
				LabelTo( from, "a map of Buccaneer's Den to Magincia" );
			if ( m_LabelNumber == 1041194 ) // map of Buccaneer's Den to Ocllo
				LabelTo( from, "a map of Buccaneer's Den to Ocllo" );
			if ( m_LabelNumber == 1041181 ) // map of Jhelom
				LabelTo( from, "a map of Jhelom" );
			if ( m_LabelNumber == 1041186 ) // map of Magincia
				LabelTo( from, "a map of Magincia" );
			if ( m_LabelNumber == 1041199 ) // map of Magincia to Ocllo
				LabelTo( from, "a map of Magincia to Ocllo" );
			if ( m_LabelNumber == 1041182 ) // map of Minoc
				LabelTo( from, "a map of Minoc" );
			if ( m_LabelNumber == 1041190 ) // map of Minoc to Yew
				LabelTo( from, "a map of Minoc to Yew" );
			if ( m_LabelNumber == 1041191 ) // map of Minoc to Vesper
				LabelTo( from, "a map of Minoc to Vesper" );
			if ( m_LabelNumber == 1041188 ) // map of Moonglow
				LabelTo( from, "a map of Moonglow" );
			if ( m_LabelNumber == 1041201 ) // map of Moonglow to Nujelm
				LabelTo( from, "a map of Moonglow to Nujel'm" );
			if ( m_LabelNumber == 1041185 ) // map of Nujelm
				LabelTo( from, "a map of Nujel'm" );
			if ( m_LabelNumber == 1041197 ) // map of Nujelm to Magincia
				LabelTo( from, "a map of Nujel'm to Magincia" );
			if ( m_LabelNumber == 1041187 ) // map of Ocllo
				LabelTo( from, "a map of Ocllo" );
			if ( m_LabelNumber == 1041184 ) // map of Serpent's Hold
				LabelTo( from, "a map of Serpent's Hold" );
			if ( m_LabelNumber == 1041200 ) // map of Serpent's Hold to Ocllo
				LabelTo( from, "a map of Serpent's Hold to Ocllo" );
			if ( m_LabelNumber == 1041180 ) // map of Skara Brae
				LabelTo( from, "a map of Skara Brae" );
			if ( m_LabelNumber == 1041204 ) // map of The World
				LabelTo( from, "a map of the world" );
			if ( m_LabelNumber == 1041177 ) // map of Trinsic
				LabelTo( from, "a map of Trinsic" );
			if ( m_LabelNumber == 1041193 ) // map of Trinsic to Buccaneer's Den
				LabelTo( from, "a map of Trinsic to Buccaneer's Den" );
			if ( m_LabelNumber == 1041195 ) // map of Trinsic to Jhelom
				LabelTo( from, "a map of Trinsic to Jhelom" );
			if ( m_LabelNumber == 1041178 ) // map of Vesper
				LabelTo( from, "a map of Vesper" );
			if ( m_LabelNumber == 1041196 ) // map of Vesper to Nujelm
				LabelTo( from, "a map of Vesper to Nujel'm" );
			if ( m_LabelNumber == 1041179 ) // map of Yew
				LabelTo( from, "a map of Yew" );
			if ( m_LabelNumber == 1041202 ) // map of Yew to Britain
				LabelTo( from, "a map of Yew to Britain" );
		}
